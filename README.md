...
<table border="0" cellpadding="12" cellspacing="0">
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p align="center">
        <a href="https://github.com/C-2631/Plant-Detection-System">
          <img src="https://github-readme-stats.vercel.app/api/pin/?username=C-2631&repo=Plant-Detection-System&theme=tokyonight&hide_border=true&bg_color=0D1117&title_color=10b981&icon_color=06b6d4&text_color=d1d5db" width="400" alt="PlantGuard AI" />
        </a>
      </p>
      <p align="center">
        <img src="https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white" />
...
```mermaid
flowchart LR
    A["📸 Leaf Image Upload<br/>(Camera / Drag & Drop)"] --> B["⚙️ OpenCV Preprocessing<br/>(Denoise · Otsu · Grayscale)"]
    B --> C["🧠 Deep Learning Model<br/>(PyTorch / CNN Classifier)"]
    C --> D["🎯 Grad-CAM Generator<br/>(Visual Attention Heatmap)"]
    C --> E["📖 63-Disease Agronomic DB<br/>(Dosages · Chemical · Organic)"]
    D --> F["📱 Interactive UI Dashboard<br/>(14 Themes · Audio · PDF Rx)"]
    E --> F

    style A fill:#10b981,stroke:#34d399,color:#000
    style B fill:#06b6d4,stroke:#22d3ee,color:#000
    style C fill:#6c3ce9,stroke:#8b5cf6,color:#fff
    style D fill:#f59e0b,stroke:#fbbf24,color:#000
